        ...
        <div class="box box-success">
          ...
          <div class="box-body">
              <div style="overflow-x:auto;">
                  <table class="table table-hover nowrap" id="myBestProduct">
                      ...
                      <tbody>
                          <?php
                          $no = 1;
                          $select = $pdo->prepare("SELECT product_code,product_name,price,order_date,sum(qty) as q, sum(qty*price) as total FROM
